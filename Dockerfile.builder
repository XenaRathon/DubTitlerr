...
WORKDIR /app
COPY generate.py reflow.py glossary.py common_words.txt repair.py dub_signs_merge.py \
     plex_refresh.py mine_glossary.py merge_pass.sh gen_loop.sh container_run.sh /app/
RUN chmod +x /app/*.sh
