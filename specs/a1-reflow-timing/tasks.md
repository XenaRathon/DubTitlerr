...
- [x] Ensure CI runs ruff + pytest (create `.github`/Forgejo workflow if none) — done when: pipeline green.
- [x] Push `feat/a1-reflow-timing` to origin — done when: branch published.
