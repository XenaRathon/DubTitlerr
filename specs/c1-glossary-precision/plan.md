...
| A canonical name that's also an English word (Robin, Law, Brook) | Names are corrected only via exact glossary/hard_fixes; the fuzzy never _targets_ a real word, so it won't mangle them. Tested.                                                   |
