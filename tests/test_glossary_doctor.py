...
def test_a_verified_term_must_be_reachable_at_runtime():
    g = {"names": ["Luffy"], "phrases": [], "hard_fixes": {},
         "verified": ["Luffy", "Doflamingo"]}
...
def test_hard_fixes_VALUES_count_as_reachable():
    ...
    g = {"names": [], "phrases": [], "hard_fixes": {"arabasta": "Alabasta"},
         "verified": ["Alabasta"]}
...
def test_a_flagged_term_is_legitimately_out_of_service():
    ...
    g = {"names": [], "phrases": [], "hard_fixes": {}, "verified": ["Ratel"],
...
def test_repair_restores_by_shape():
    g = {"names": [], "phrases": [], "hard_fixes": {},
         "verified": ["Doflamingo", "Straw Hat Pirates"]}
    out, _ = doc.repair(g)
...
def test_repair_is_idempotent():
    g = {"names": ["Boa Hancock"], "phrases": [], "hard_fixes": {},
         "verified": ["Doflamingo"]}
    once, _ = doc.repair(g)
...
def test_drop_prompt_terms_splits_on_fields_not_substrings():
    ...
    g = {"initial_prompt": "Spell names correctly: Luffy, Zoro. Attack names: "
                           "Gum-Gum Pistol, Gum-Gum Bazooka, Gear Second.",
         "phrases": ["Gum-Gum Pistol", "Gum-Gum Bazooka", "Gear Second"]}
    out, dropped = doc.drop_prompt_terms(g, ["Gum-Gum Bazooka", "Gear Second"],
                                         "unverified-attack-name")
